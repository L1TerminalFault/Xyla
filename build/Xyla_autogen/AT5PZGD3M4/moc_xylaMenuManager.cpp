/****************************************************************************
** Meta object code from reading C++ file 'xylaMenuManager.hpp'
**
...
#include "../../../src/ui/menu/xylaMenuManager.hpp"
...
#error "The header file 'xylaMenuManager.hpp' doesn't include <QObject>."
...
void xyla::MenuManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->rebuildMenuTree(); break;
        case 8: _t->triggerAction((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
