...
Button {
    ...
    background: Rectangle {
        ...
        color: control.primary ? "#0011389F" : (control.outline ? (control.down ? "#27272a" : (control.hovered ? "#1f1f23" : "transparent")) : (control.down ? "#353535" : (control.hovered ? "#262626" : (control.sleek ? "#00262626" : "#181818"))))
