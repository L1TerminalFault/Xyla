...
public:
    ...
    [[nodiscard]] const std::vector<std::unique_ptr<AudioNode>> &nodes() const noexcept { return m_nodes; }
    [[nodiscard]] const std::vector<GraphConnection> &connections() const noexcept { return m_connections; }
